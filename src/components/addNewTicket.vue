<template>
  <v-dialog v-model="previewDialog" width="650" height="500" class="rounded-3xl dragFont">
    <template v-slot:activator="{ on, attrs }">
      <button @click="changeDialog(true)" class="bg-teal-600 w-32 h-12 mr-4 rounded-3xl hover:bg-yellow-700" v-bind="attrs" v-on="on" >
            ...
            <div class="flex-auto justify-evenly">
              <div class="flex items-center justify-between">
                <div class="flex items-center  my-1">
                  ...
                  <h2 class="text-s font-bold">Add Ticket</h2>
                </div>
